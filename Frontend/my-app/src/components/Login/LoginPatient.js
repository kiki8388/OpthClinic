...
const LoginPatient = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await axios.post('https://localhost:44345/api/login/patient', newLogin.loginData,)
            setLoginData({
                email: '',
                password: ''
            });
    ...
    return (
        <>
            ...
            <Routes>
                <Route path="/patient/*" element={<PatientHome cookies={cookies} />} />
            </Routes>
        </>
    )
}
