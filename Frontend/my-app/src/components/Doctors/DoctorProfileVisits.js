...
const DoctorProfileVisits = (doctor) => {
    ...
    useEffect(() => {
        ...
        const fetchVisits = async () => {
            try {
                const response = await axios.get(`https://localhost:44345/api/${doctor.doctor.id}/all_visits`, { headers: auth });
...
export default DoctorProfileVisits