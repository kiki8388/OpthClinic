...
const DoctorVisitsForPatient = (doctors) => {
    const { id } = useParams();
                            ...
                            <Table>
                                ...
                                <TableHead>
                                    <TableRow style={{ backgroundColor: "#1D3557", color: "#F1FAEE" }}>
                                        ...
                                        <TableCell style={{ color: "#F1FAEE", width: "45%" }} align="center">Date</TableCell>
                                        <TableCell style={{ color: "#F1FAEE", width: "45%" }} align="center">Room</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
...
export default DoctorVisitsForPatient