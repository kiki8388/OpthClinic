...
const DisplayDirectorsBasicData = ({ directors }) => {
                                ...
                                <TableBody>
                                    {directors.map((director, index) => (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell align="center" style={{ width: "30%" }}>{director.firstName}</TableCell>
                                            <TableCell align="center" style={{ width: "30%" }}>{director.lastName}</TableCell>
                                            <TableCell align="center" style={{ width: "30%" }}>{director.email}</TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
                            </Table>
...
export default DisplayDirectorsBasicData