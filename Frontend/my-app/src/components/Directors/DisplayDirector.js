...
const DisplayDirector = (directors) => {
    const { id } = useParams();
    ...
    //     try {
    //         await axios.delete(`https://localhost:44345/api/director/directors/${id}/delete`)
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        <TableRow>
                                            ...
                                            <TableCell align='center' colSpan={2}>{director.firstName}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>Last Name</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.lastName}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>License ID</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.licenseId}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>Email</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.email}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>Phone</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.phone}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>Street</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.streetName}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>Building number</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.buildingNumber}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>Postal code</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.postalCode}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>City</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.city}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            <TableCell align='center'>Country</TableCell>
                                            <TableCell align='center' colSpan={2}>{director.country}</TableCell>
                                        </TableRow>
                                        <TableRow>
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell align='center' style={{ width: "33.33%" }}>
                                                <Button style={{ backgroundColor: "#1D3557" }} variant="contained" onClick={() => handleEditData(director.id)}>Accept changes</Button>
                                            </TableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
