...
const ChangeDirectorPassword = (director) => {
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell align='center' style={{ width: "33.33%" }}>
                                            <Button style={{ backgroundColor: "#1D3557" }} variant="contained" onClick={() => handleChangePassword(director.director.id)}>Accept changes</Button>
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
