...
const ChangeNursePassword = (nurses) => {
    const { id } = useParams();
                                ...
                                <TableBody>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell align='center' style={{ width: "33.33%" }}>
                                            <Button variant="contained" onClick={() => navigate(`/${path[1]}/nurses/${nurse.id}`)}>Cancel</Button>
                                        </TableCell>
                                        <TableCell align='center' style={{ width: "33.33%" }}>
                                            <Button style={{ backgroundColor: "#1D3557" }} variant="contained" onClick={() => handleChangePassword(nurse.id)}>Accept changes</Button>
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
...
export default ChangeNursePassword