...
const pages = ['Home', 'Patients', 'Nurses', 'Doctors', 'Directors'];
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={handleCloseUserMenu}>
                  <Link key={setting} to={`/${path[1]}/${setting}`}><Typography style={{ color: "black" }} textAlign="center">{setting}</Typography></Link>
                </MenuItem>
              ))}
              <MenuItem>
