...
import DisplayPatientForNurse from './DisplayPatientForNurse';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path=":id" element={<DisplayPatientForNurse
          patients={patients} />} />
...
export default PatientsForNurse
