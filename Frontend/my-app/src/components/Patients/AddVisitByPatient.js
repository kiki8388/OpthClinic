...
const AddVisitByPatient = (patient) => {
    ...
    useEffect(() => {
        ...
        fetchDoctors();
        if (patient.patient) setVisitData({
                        ...
                        <div className='registerForm'>
                            <form onSubmit={handleCreateVisit}>
                                ...
                                <FormControl>
                                    ...
                                    >
                                        <MenuItem value={patient.patient.id}> {patient.patient.firstName} {patient.patient.lastName}</MenuItem>
                                    </Select>
                                </FormControl>
                                <FormControl>
...
export default AddVisitByPatient